...
define float @"\01floor__const_math_fmodf"(float %y, float %x) #0 {
  %1 = tail call float @_Z4fmodff(float %y, float %x) #1
  ret float %1
}
...
define float @"\01floor__const_math_sqrtf"(float %val) #0 {
  %1 = tail call float @_Z4sqrtf(float %val) #1
  ret float %1
}
...
define float @"\01floor__const_math_inv_sqrtf"(float %val) #0 {
  %1 = tail call float @_Z5rsqrtf(float %val) #1
  ret float %1
}
...
define float @"\01floor__const_math_absf"(float %val) #0 {
  %1 = tail call float @_Z4fabsf(float %val) #1
  ret float %1
}
...
define float @"\01floor__const_math_floorf"(float %val) #0 {
  %1 = tail call float @_Z5floorf(float %val) #1
  ret float %1
}
...
define float @"\01floor__const_math_ceilf"(float %val) #0 {
  %1 = tail call float @_Z4ceilf(float %val) #1
  ret float %1
}
...
define float @"\01floor__const_math_roundf"(float %val) #0 {
  %1 = tail call float @_Z5roundf(float %val) #1
  ret float %1
}
...
define float @"\01floor__const_math_truncf"(float %val) #0 {
  %1 = tail call float @_Z5truncf(float %val) #1
  ret float %1
}
...
define float @"\01floor__const_math_rintf"(float %val) #0 {
  %1 = tail call float @_Z4rintf(float %val) #1
  ret float %1
}
...
define float @"\01floor__const_math_sinf"(float %val) #0 {
  %1 = tail call float @_Z3sinf(float %val) #1
  ret float %1
}
...
define float @"\01floor__const_math_cosf"(float %val) #0 {
  %1 = tail call float @_Z3cosf(float %val) #1
  ret float %1
}
...
define float @"\01floor__const_math_tanf"(float %val) #0 {
  %1 = tail call float @_Z3tanf(float %val) #1
  ret float %1
}
...
define float @"\01floor__const_math_asinf"(float %val) #0 {
  %1 = tail call float @_Z4asinf(float %val) #1
  ret float %1
}
...
define float @"\01floor__const_math_acosf"(float %val) #0 {
  %1 = tail call float @_Z4acosf(float %val) #1
  ret float %1
}
...
define float @"\01floor__const_math_atanf"(float %val) #0 {
  %1 = tail call float @_Z4atanf(float %val) #1
  ret float %1
}
...
define float @"\01floor__const_math_atan2f"(float %y, float %x) #0 {
  %1 = tail call float @_Z5atan2ff(float %y, float %x) #1
  ret float %1
}
...
define float @"\01floor__const_math_fmaf"(float %a, float %b, float %c) #0 {
  %1 = tail call float @_Z3fmafff(float %a, float %b, float %c) #1
  ret float %1
}
...
define float @"\01floor__const_math_expf"(float %val) #0 {
  %1 = tail call float @_Z3expf(float %val) #1
  ret float %1
}
...
define float @"\01floor__const_math_logf"(float %val) #0 {
  %1 = tail call float @_Z3logf(float %val) #1
  ret float %1
}
...
define double @"\01floor__const_math_fmodd"(double %y, double %x) #0 {
  %1 = tail call double @_Z4fmoddd(double %y, double %x) #1
  ret double %1
}
...
define double @"\01floor__const_math_sqrtd"(double %val) #0 {
  %1 = tail call double @_Z4sqrtd(double %val) #1
  ret double %1
}
...
define double @"\01floor__const_math_inv_sqrtd"(double %val) #0 {
  %1 = tail call double @_Z5rsqrtd(double %val) #1
  ret double %1
}
...
define double @"\01floor__const_math_absd"(double %val) #0 {
  %1 = tail call double @_Z4fabsd(double %val) #1
  ret double %1
}
...
define double @"\01floor__const_math_floord"(double %val) #0 {
  %1 = tail call double @_Z5floord(double %val) #1
  ret double %1
}
...
define double @"\01floor__const_math_ceild"(double %val) #0 {
  %1 = tail call double @_Z4ceild(double %val) #1
  ret double %1
}
...
define double @"\01floor__const_math_roundd"(double %val) #0 {
  %1 = tail call double @_Z5roundd(double %val) #1
  ret double %1
}
...
define double @"\01floor__const_math_truncd"(double %val) #0 {
  %1 = tail call double @_Z5truncd(double %val) #1
  ret double %1
}
...
define double @"\01floor__const_math_rintd"(double %val) #0 {
  %1 = tail call double @_Z4rintd(double %val) #1
  ret double %1
}
...
define double @"\01floor__const_math_sind"(double %val) #0 {
  %1 = tail call double @_Z3sind(double %val) #1
  ret double %1
}
...
define double @"\01floor__const_math_cosd"(double %val) #0 {
  %1 = tail call double @_Z3cosd(double %val) #1
  ret double %1
}
...
define double @"\01floor__const_math_tand"(double %val) #0 {
  %1 = tail call double @_Z3tand(double %val) #1
  ret double %1
}
...
define double @"\01floor__const_math_asind"(double %val) #0 {
  %1 = tail call double @_Z4asind(double %val) #1
  ret double %1
}
...
define double @"\01floor__const_math_acosd"(double %val) #0 {
  %1 = tail call double @_Z4acosd(double %val) #1
  ret double %1
}
...
define double @"\01floor__const_math_atand"(double %val) #0 {
  %1 = tail call double @_Z4atand(double %val) #1
  ret double %1
}
...
define double @"\01floor__const_math_atan2d"(double %y, double %x) #0 {
  %1 = tail call double @_Z5atan2dd(double %y, double %x) #1
  ret double %1
}
...
define double @"\01floor__const_math_fmad"(double %a, double %b, double %c) #0 {
  %1 = tail call double @_Z3fmaddd(double %a, double %b, double %c) #1
  ret double %1
}
...
define double @"\01floor__const_math_expd"(double %val) #0 {
  %1 = tail call double @_Z3expd(double %val) #1
  ret double %1
}
...
define double @"\01floor__const_math_logd"(double %val) #0 {
  %1 = tail call double @_Z3logd(double %val) #1
  ret double %1
}
...
define spir_kernel void @_Z10path_tracePU3AS17vector3IfEjj7vector2IjE(%class.vector3 addrspace(1)* nocapture %img, i32 %iteration, i32 %seed, %class.vector2.23* byval nocapture %img_size) #2 {
  ...
  %36 = fdiv float %34, %35, !fpmath !14
  %37 = tail call float @_Z3tanf(float 0x3FD38C3540000000) #1
  %38 = fmul float %37, -2.000000e+00
  %39 = fmul float %36, %38
  %40 = fdiv float %39, %34, !fpmath !14
  %41 = fdiv float 0.000000e+00, %34, !fpmath !14
  %42 = fdiv float -0.000000e+00, %35, !fpmath !14
  %43 = fdiv float %38, %35, !fpmath !14
  %44 = fdiv float 0.000000e+00, %35, !fpmath !14
  ...
  call void @_ZN18simple_path_tracer16compute_radianceILj0ELi0EEE7vector3IfERK3rayRjb(%class.vector3* sret %color, %struct.ray* %r, i32* %random_seed, i1 zeroext true)
...
; <label>:75                                      ; preds = %0
  ...
  %78 = fdiv float 1.000000e+00, %77, !fpmath !14
...
; Function Attrs: nounwind
define linkonce_odr void @_ZN18simple_path_tracer16compute_radianceILj0ELi0EEE7vector3IfERK3rayRjb(%class.vector3* noalias nocapture sret %agg.result, %struct.ray* nocapture %r, i32* nocapture %random_seed, i1 zeroext %sample_emission) #2 align 2 {
  ...
  call void @_ZN18simple_intersector9intersectERK3ray(%"struct.simple_intersector::intersection"* sret %p, %struct.ray* %r)
...
; <label>:21                                      ; preds = %14, %11
  ...
  call void @_ZN18simple_path_tracer27compute_direct_illuminationERK7vector3IfERKN18simple_intersector12intersectionERK8materialRj(%class.vector3* sret %1, %class.vector3* %2, %"struct.simple_intersector::intersection"* %p, %struct.material* %13, i32* %random_seed)
  ...
  %45 = fadd float %22, %44
  call void @_ZN18simple_path_tracer29compute_indirect_illuminationILj0EEE7vector3IfERK3rayRKN18simple_intersector12intersectionERK8materialRj(%class.vector3* sret %3, %struct.ray* %r, %"struct.simple_intersector::intersection"* %p, %struct.material* %13, i32* %random_seed)
...
; Function Attrs: nounwind
define linkonce_odr void @_ZN18simple_intersector9intersectERK3ray(%"struct.simple_intersector::intersection"* noalias nocapture sret %agg.result, %struct.ray* nocapture %r) #2 align 2 {
...
; <label>:70                                      ; preds = %_ZN10const_math3absIfvEET_S1_.exit
  %71 = fdiv float 1.000000e+00, %64, !fpmath !14
  %72 = fsub float %8, %30
  %73 = fsub float %10, %35
  %74 = fsub float %12, %40
  %75 = fmul float %41, %73
...
; <label>:101                                     ; preds = %_ZNK7vector3IbE3anyIbvEEbv.exit
  %102 = fmul float %44, %77
  %103 = fmul float %47, %80
  %104 = fadd float %102, %103
  %105 = fmul float %50, %83
  %106 = fadd float %105, %104
  %107 = fmul float %71, %106
...
; <label>:110                                     ; preds = %101
  %111 = fmul float %36, %50
  %112 = fmul float %41, %47
  %113 = fsub float %111, %112
  %114 = fmul float %41, %44
  %115 = fmul float %31, %50
  %116 = fsub float %114, %115
  %117 = fmul float %31, %47
  %118 = fmul float %36, %44
...
_ZNK7vector3IfE7is_nullEv.exit.thread.i:          ; preds = %110
  %123 = fmul float %113, %113
  %124 = fmul float %116, %116
  %125 = fadd float %123, %124
  %126 = fmul float %119, %119
  %127 = fadd float %126, %125
  %128 = tail call float @_Z5rsqrtf(float %127) #1
  %129 = fmul float %113, %128
  %130 = fmul float %116, %128
  %131 = fmul float %119, %128
...
; <label>:143                                     ; preds = %_ZNK7vector3IbE3anyIbvEEbv.exit.thread
  ...
  %144 = fmul float %.lcssa28, %6
  %145 = fmul float %.lcssa28, %2
  %146 = fmul float %.lcssa28, %4
  %147 = fadd float %144, %8
  %148 = fadd float %145, %10
  %149 = fadd float %146, %12
...
_ZNK7vector3IfE7is_nullEv.exit.thread.i:          ; preds = %0
  ...
  %16 = fmul float %11, %11
  %17 = fadd float %15, %16
  %18 = tail call float @_Z5rsqrtf(float %17) #1
  %19 = fmul float %5, %18
  %20 = fmul float %8, %18
  %21 = fmul float %11, %18
  br label %_ZNK7vector3IfE10normalizedEv.exit
...
_ZNK7vector3IfE7is_nullEv.exit.thread.i3:         ; preds = %_ZNK7vector3IfE10normalizedEv.exit
  ...
  %37 = fmul float %32, %32
  %38 = fadd float %36, %37
  %39 = tail call float @_Z5rsqrtf(float %38) #1
  %40 = fmul float %26, %39
  %41 = fmul float %29, %39
  %42 = fmul float %32, %39
...
_ZNK7vector3IfE10normalizedEv.exit4:              ; preds = %_ZNK7vector3IfE7is_nullEv.exit.thread.i3, %_ZNK7vector3IfE10normalizedEv.exit
  ...
  %57 = fmul float %51, 1.050000e+01
  %58 = fadd float %57, 0x4036B33340000000
  %59 = fmul float %56, -1.300000e+01
  %60 = fadd float %59, 0x4041266660000000
  ...
  %66 = fsub float 0x404B666660000000, %65
...
_ZNK7vector3IfE7is_nullEv.exit.thread.i13:        ; preds = %_ZNK7vector3IfE10normalizedEv.exit4
  %82 = tail call float @_Z5rsqrtf(float %74) #1
  %83 = fmul float %63, %82
  %84 = fmul float %66, %82
  %85 = fmul float %69, %82
...
_ZNK7vector3IfE10normalizedEv.exit14:             ; preds = %_ZNK7vector3IfE7is_nullEv.exit.thread.i13, %_ZNK7vector3IfE10normalizedEv.exit4
  ...
  call void @_ZN18simple_intersector9intersectERK3ray(%"struct.simple_intersector::intersection"* sret %ret, %struct.ray* %r)
...
; <label>:95                                      ; preds = %_ZNK7vector3IfE10normalizedEv.exit14
  ...
  %98 = tail call float @_Z4sqrtf(float %..i15) #1
  %99 = fadd float %98, 0xBF1A36E2E0000000
...
; <label>:102                                     ; preds = %95, %_ZNK7vector3IfE10normalizedEv.exit14
  %103 = fdiv float 1.000000e+00, %..i15, !fpmath !14
  %104 = fcmp ogt float %87, 0.000000e+00
  %..i10 = select i1 %104, float %87, float 0.000000e+00
  %105 = fmul float %24, %86
  %106 = fmul float %23, %87
  %107 = fadd float %106, %105
  %108 = fmul float %22, %88
...
_ZNK7vector3IfE7is_nullEv.exit.thread:            ; preds = %_ZNK7vector3IfE7is_nullEv.exit, %120, %102
  %127 = fsub float -0.000000e+00, %86
  %128 = fsub float -0.000000e+00, %87
  %129 = fsub float -0.000000e+00, %88
  %130 = fmul float %24, %127
  %131 = fmul float %23, %128
  %132 = fadd float %130, %131
  %133 = fmul float %22, %129
  %134 = fadd float %132, %133
  %135 = fmul float %134, 2.000000e+00
  %136 = fmul float %24, %135
  %137 = fmul float %23, %135
  %138 = fmul float %22, %135
  %139 = fsub float %127, %136
  %140 = fsub float %128, %137
...
_ZNK7vector3IfE7is_nullEv.exit.thread.i7:         ; preds = %_ZNK7vector3IfE7is_nullEv.exit.thread
  %145 = fmul float %139, %139
  %146 = fmul float %140, %140
  %147 = fadd float %145, %146
  %148 = fmul float %141, %141
  %149 = fadd float %148, %147
  %150 = tail call float @_Z5rsqrtf(float %149) #1
  %151 = fmul float %139, %150
  %152 = fmul float %140, %150
  %153 = fmul float %141, %150
...
_ZNK7vector3IfE10normalizedEv.exit8:              ; preds = %_ZNK7vector3IfE7is_nullEv.exit.thread.i7, %_ZNK7vector3IfE7is_nullEv.exit.thread
  ...
  %157 = fmul float %45, %156
  %158 = fmul float %44, %155
  %159 = fadd float %158, %157
  %160 = fmul float %43, %154
  ...
  %165 = tail call float @_Z3powff(float %..i, float %164) #1
  ...
  %175 = fadd float %112, %168
  %176 = fadd float %114, %171
  %177 = fadd float %116, %174
  br label %178
...
; <label>:178                                     ; preds = %_ZNK7vector3IfE10normalizedEv.exit8, %_ZNK7vector3IfE7is_nullEv.exit
  ...
  %182 = fmul float %..i10, %..i9
  %183 = tail call float @_Z4sqrtf(float 1.863225e+04) #1
  %184 = fmul float %182, %183
  %185 = fmul float %103, %184
  %186 = fmul float %185, 1.500000e+01
  %187 = fmul float %181, %186
  %188 = fmul float %180, %186
  %189 = fmul float %179, %186
...
; <label>:23                                      ; preds = %0
  ...
  %25 = fsub float -0.000000e+00, %11
  %26 = fsub float -0.000000e+00, %17
...
; <label>:66                                      ; preds = %32
  call void @_ZN18simple_path_tracer16get_local_systemERK7vector3IfE(%"struct.std::__1::pair"* sret %tb, %class.vector3* %normal)
  ...
  %81 = fmul float %74, 0x401921FB60000000
  %82 = fsub float 2.000000e+00, %78
  %83 = tail call float @_Z4sqrtf(float %82) #1
  %84 = tail call float @_Z4sqrtf(float %79) #1
  %85 = tail call float @_Z3cosf(float %81) #1
  %86 = fmul float %83, %85
  %87 = tail call float @_Z3sinf(float %81) #1
  %88 = fmul float %83, %87
  ...
  call void @_ZN18simple_path_tracer13transform_dirER7vector3IfERKS1_S4_S4_(%class.vector3* %dir.i5, %class.vector3* %normal, %class.vector3* %67, %class.vector3* %68) #2
  ...
  %101 = fmul float %92, %34
  %102 = fmul float %93, %33
  %103 = fadd float %101, %102
  %104 = fmul float %94, %35
  %105 = fadd float %103, %104
  %106 = fcmp ogt float %105, 0.000000e+00
  %..i4 = select i1 %106, float %105, float 0.000000e+00
  %107 = fmul float %96, %..i4
  %108 = fmul float %98, %..i4
  %109 = fmul float %100, %..i4
...
; <label>:113                                     ; preds = %66
  %114 = fmul float %84, 0x3FD45F3060000000
  ...
  call void @_ZN18simple_path_tracer16compute_radianceILj1ELi0EEE7vector3IfERK3rayRjb(%class.vector3* sret %1, %struct.ray* %2, i32* %random_seed, i1 zeroext false)
  %127 = getelementptr inbounds %class.vector3* %1, i64 0, i32 0, i32 0, i32 0
  %128 = load float* %127, align 4, !tbaa !15
  %129 = fmul float %107, %128
  ...
  %135 = fmul float %109, %134
  %136 = fmul float %47, %114
  %137 = fdiv float %129, %136, !fpmath !14
  %138 = fdiv float %132, %136, !fpmath !14
  %139 = fdiv float %135, %136, !fpmath !14
  br label %271

; <label>:140                                     ; preds = %32
  %141 = fadd float %47, %58
  %142 = fcmp olt float %64, %141
  br i1 %142, label %143, label %271

; <label>:143                                     ; preds = %140
  %144 = fmul float %34, %8
  %145 = fmul float %33, %13
  %146 = fadd float %144, %145
  %147 = fmul float %35, %19
  %148 = fadd float %146, %147
  %149 = fmul float %148, 2.000000e+00
  %150 = fmul float %34, %149
  %151 = fmul float %33, %149
  %152 = fmul float %35, %149
  %153 = fsub float %8, %150
  %154 = fsub float %13, %151
  %155 = fsub float %19, %152
...
_ZNK7vector3IfE7is_nullEv.exit.thread.i:          ; preds = %143
  %159 = fmul float %153, %153
  %160 = fmul float %154, %154
  %161 = fadd float %159, %160
  %162 = fmul float %155, %155
  %163 = fadd float %162, %161
  %164 = tail call float @_Z5rsqrtf(float %163) #1
  %165 = fmul float %153, %164
  %166 = fmul float %154, %164
  %167 = fmul float %155, %164
  br label %_ZNK7vector3IfE10normalizedEv.exit
...
_ZNK7vector3IfE10normalizedEv.exit:               ; preds = %_ZNK7vector3IfE7is_nullEv.exit.thread.i, %143
  ...
  call void @_ZN18simple_path_tracer16get_local_systemERK7vector3IfE(%"struct.std::__1::pair"* sret %tb1, %class.vector3* %rnormal)
  ...
  %190 = fmul float %181, 0x401921FB60000000
  %191 = fadd float %188, 1.000000e+00
  %192 = fdiv float 1.000000e+00, %191, !fpmath !14
  %193 = tail call float @_Z3powff(float %186, float %192) #1
  %194 = fmul float %193, %193
  %195 = fsub float 1.000000e+00, %194
  %196 = tail call float @_Z4sqrtf(float %195) #1
  %197 = tail call float @_Z3cosf(float %190) #1
  %198 = fmul float %196, %197
  %199 = tail call float @_Z3sinf(float %190) #1
  ...
  call void @_ZN18simple_path_tracer13transform_dirER7vector3IfERKS1_S4_S4_(%class.vector3* %dir.i, %class.vector3* %rnormal, %class.vector3* %174, %class.vector3* %175) #2
  %204 = load float* %201, align 4, !tbaa !15
  %205 = load float* %202, align 4, !tbaa !18
  %206 = load float* %203, align 4, !tbaa !19
  %207 = call float @_Z3powff(float %193, float %188) #1
  %208 = fmul float %191, %207
  %209 = fmul float %208, 0x3FC45F3060000000
  call void @llvm.lifetime.end(i64 12, i8* %189)
  %210 = fmul float %204, %34
  %211 = fmul float %205, %33
  %212 = fadd float %210, %211
  %213 = fmul float %206, %35
...
; <label>:220                                     ; preds = %_ZNK7vector3IfE10normalizedEv.exit
  ...
  %227 = fmul float %204, %168
  %228 = fmul float %205, %169
  %229 = fadd float %227, %228
  %230 = fmul float %206, %170
  ...
  %234 = call float @_Z3powff(float %..i3, float %233) #1
  ...
  %239 = fmul float %..i, %235
  %240 = fmul float %..i, %236
  %241 = fmul float %..i, %237
...
; <label>:245                                     ; preds = %220
  ...
  call void @_ZN18simple_path_tracer16compute_radianceILj1ELi0EEE7vector3IfERK3rayRjb(%class.vector3* sret %3, %struct.ray* %4, i32* %random_seed, i1 zeroext false)
  ...
  %263 = fmul float %240, %262
  %264 = getelementptr inbounds %class.vector3* %3, i64 0, i32 0, i32 0, i32 2
  %265 = load float* %264, align 4, !tbaa !19
  %266 = fmul float %241, %265
  %267 = fmul float %58, %209
  %268 = fdiv float %260, %267, !fpmath !14
  %269 = fdiv float %263, %267, !fpmath !14
  %270 = fdiv float %266, %267, !fpmath !14
  br label %271
...
; Function Attrs: nounwind
define linkonce_odr void @_ZN18simple_path_tracer16get_local_systemERK7vector3IfE(%"struct.std::__1::pair"* noalias nocapture sret %agg.result, %class.vector3* nocapture %normal) #2 align 2 {
...
_ZN10const_math3absIfvEET_S1_.exit7:              ; preds = %25, %_ZN10const_math3absIfvEET_S1_.exit8
  ...
  %35 = fmul float %34, %34
  %36 = fadd float %32, %35
  %37 = fdiv float 1.000000e+00, %36, !fpmath !14
...
_ZNK7vector3IfE7is_nullEv.exit.thread.i4:         ; preds = %_ZN10const_math3absIfvEET_S1_.exit7
  ...
  %56 = fmul float %46, %46
  %57 = fadd float %55, %56
  %58 = tail call float @_Z5rsqrtf(float %57) #1
  %59 = fmul float %48, %58
...
_ZNK7vector3IfE7is_nullEv.exit.thread.i:          ; preds = %_ZN7vector3IfE9normalizeEv.exit5
  ...
  %80 = fmul float %73, %73
  %81 = fadd float %80, %79
  %82 = tail call float @_Z5rsqrtf(float %81) #1
  %83 = fmul float %67, %82
  %84 = fmul float %70, %82
  %85 = fmul float %73, %82
...
; Function Attrs: nounwind
define linkonce_odr void @_ZN18simple_path_tracer16compute_radianceILj1ELi0EEE7vector3IfERK3rayRjb(%class.vector3* noalias nocapture sret %agg.result, %struct.ray* nocapture %r, i32* nocapture %random_seed, i1 zeroext %sample_emission) #2 align 2 {
  %p = alloca %"struct.simple_intersector::intersection", align 4
  %1 = alloca %class.vector3, align 4
  %2 = alloca %class.vector3, align 4
  %3 = alloca %class.vector3, align 4
...
; <label>:21                                      ; preds = %14, %11
  ...
  %44 = load float* %43, align 4, !tbaa !19
  %45 = fadd float %22, %44
  call void @_ZN18simple_path_tracer29compute_indirect_illuminationILj1EEE7vector3IfERK3rayRKN18simple_intersector12intersectionERK8materialRj(%class.vector3* sret %3, %struct.ray* %r, %"struct.simple_intersector::intersection"* %p, %struct.material* %13, i32* %random_seed)
  %46 = getelementptr inbounds %class.vector3* %3, i64 0, i32 0, i32 0, i32 0
  %47 = load float* %46, align 4, !tbaa !15
  %48 = fadd float %39, %47
  %49 = getelementptr inbounds %class.vector3* %3, i64 0, i32 0, i32 0, i32 1
...
; Function Attrs: nounwind
define linkonce_odr void @_ZN18simple_path_tracer13transform_dirER7vector3IfERKS1_S4_S4_(%class.vector3* %dir, %class.vector3* nocapture %up, %class.vector3* nocapture %left, %class.vector3* nocapture %forward) #2 align 2 {
...
_ZNK7vector3IfE7is_nullEv.exit.thread.i:          ; preds = %0
  ...
  %14 = fmul float %8, %8
  %15 = fadd float %12, %14
  %16 = tail call float @_Z5rsqrtf(float %15) #1
  %17 = fmul float %2, %16
...
_ZNK7vector3IfE7is_nullEv.exit.thread.i3:         ; preds = %_ZN7vector3IfE9normalizeEv.exit
  ...
  %63 = fmul float %56, %56
  %64 = fadd float %62, %63
  %65 = tail call float @_Z5rsqrtf(float %64) #1
  %66 = fmul float %34, %65
...
; <label>:113                                     ; preds = %66
  ...
  %126 = getelementptr inbounds %struct.ray* %2, i64 0, i32 1, i32 0, i32 0, i32 2
  store float %94, float* %126, align 4, !tbaa !19
  call void @_ZN18simple_path_tracer16compute_radianceILj2ELi0EEE7vector3IfERK3rayRjb(%class.vector3* sret %1, %struct.ray* %2, i32* %random_seed, i1 zeroext false)
  %127 = getelementptr inbounds %class.vector3* %1, i64 0, i32 0, i32 0, i32 0
  %128 = load float* %127, align 4, !tbaa !15
  %129 = fmul float %107, %128
  %130 = getelementptr inbounds %class.vector3* %1, i64 0, i32 0, i32 0, i32 1
...
; <label>:245                                     ; preds = %220
  ...
  %257 = getelementptr inbounds %struct.ray* %4, i64 0, i32 1, i32 0, i32 0, i32 2
  store float %206, float* %257, align 4, !tbaa !19
  call void @_ZN18simple_path_tracer16compute_radianceILj2ELi0EEE7vector3IfERK3rayRjb(%class.vector3* sret %3, %struct.ray* %4, i32* %random_seed, i1 zeroext false)
  %258 = getelementptr inbounds %class.vector3* %3, i64 0, i32 0, i32 0, i32 0
  %259 = load float* %258, align 4, !tbaa !15
  %260 = fmul float %239, %259
  %261 = getelementptr inbounds %class.vector3* %3, i64 0, i32 0, i32 0, i32 1
...
; Function Attrs: nounwind
define linkonce_odr void @_ZN18simple_path_tracer16compute_radianceILj2ELi0EEE7vector3IfERK3rayRjb(%class.vector3* noalias nocapture sret %agg.result, %struct.ray* nocapture %r, i32* nocapture %random_seed, i1 zeroext %sample_emission) #2 align 2 {
  %p = alloca %"struct.simple_intersector::intersection", align 4
  %1 = alloca %class.vector3, align 4
  %2 = alloca %class.vector3, align 4
  %3 = alloca %class.vector3, align 4
...
; <label>:21                                      ; preds = %14, %11
  ...
  %44 = load float* %43, align 4, !tbaa !19
  %45 = fadd float %22, %44
  call void @_ZN18simple_path_tracer29compute_indirect_illuminationILj2EEE7vector3IfERK3rayRKN18simple_intersector12intersectionERK8materialRj(%class.vector3* sret %3, %struct.ray* %r, %"struct.simple_intersector::intersection"* %p, %struct.material* %13, i32* %random_seed)
  %46 = getelementptr inbounds %class.vector3* %3, i64 0, i32 0, i32 0, i32 0
  %47 = load float* %46, align 4, !tbaa !15
  %48 = fadd float %39, %47
  %49 = getelementptr inbounds %class.vector3* %3, i64 0, i32 0, i32 0, i32 1
...
; <label>:113                                     ; preds = %66
  ...
  %126 = getelementptr inbounds %struct.ray* %2, i64 0, i32 1, i32 0, i32 0, i32 2
  store float %94, float* %126, align 4, !tbaa !19
  call void @_ZN18simple_path_tracer16compute_radianceILj3ELi0EEE7vector3IfERK3rayRjb(%class.vector3* sret %1, %struct.ray* %2, i32* %random_seed, i1 zeroext false)
  %127 = getelementptr inbounds %class.vector3* %1, i64 0, i32 0, i32 0, i32 0
  %128 = load float* %127, align 4, !tbaa !15
  %129 = fmul float %107, %128
  %130 = getelementptr inbounds %class.vector3* %1, i64 0, i32 0, i32 0, i32 1
...
; <label>:245                                     ; preds = %220
  ...
  %257 = getelementptr inbounds %struct.ray* %4, i64 0, i32 1, i32 0, i32 0, i32 2
  store float %206, float* %257, align 4, !tbaa !19
  call void @_ZN18simple_path_tracer16compute_radianceILj3ELi0EEE7vector3IfERK3rayRjb(%class.vector3* sret %3, %struct.ray* %4, i32* %random_seed, i1 zeroext false)
  %258 = getelementptr inbounds %class.vector3* %3, i64 0, i32 0, i32 0, i32 0
  %259 = load float* %258, align 4, !tbaa !15
  %260 = fmul float %239, %259
  %261 = getelementptr inbounds %class.vector3* %3, i64 0, i32 0, i32 0, i32 1
...
; Function Attrs: nounwind
define linkonce_odr void @_ZN18simple_path_tracer16compute_radianceILj3ELi0EEE7vector3IfERK3rayRjb(%class.vector3* noalias nocapture sret %agg.result, %struct.ray* nocapture %r, i32* nocapture %random_seed, i1 zeroext %sample_emission) #2 align 2 {
  %p = alloca %"struct.simple_intersector::intersection", align 4
  %1 = alloca %class.vector3, align 4
  %2 = alloca %class.vector3, align 4
  %3 = alloca %class.vector3, align 4
...
; <label>:21                                      ; preds = %14, %11
  ...
  %44 = load float* %43, align 4, !tbaa !19
  %45 = fadd float %22, %44
  call void @_ZN18simple_path_tracer29compute_indirect_illuminationILj3EEE7vector3IfERK3rayRKN18simple_intersector12intersectionERK8materialRj(%class.vector3* sret %3, %struct.ray* %r, %"struct.simple_intersector::intersection"* %p, %struct.material* %13, i32* %random_seed)
  %46 = getelementptr inbounds %class.vector3* %3, i64 0, i32 0, i32 0, i32 0
  %47 = load float* %46, align 4, !tbaa !15
  %48 = fadd float %39, %47
  %49 = getelementptr inbounds %class.vector3* %3, i64 0, i32 0, i32 0, i32 1
...
; <label>:19                                      ; preds = %0
  %20 = fsub float -0.000000e+00, %2
  %21 = fsub float -0.000000e+00, %7
  %22 = fsub float -0.000000e+00, %13
...
; <label>:62                                      ; preds = %28
  ...
  %77 = fmul float %70, 0x401921FB60000000
  %78 = fsub float 2.000000e+00, %74
  %79 = tail call float @_Z4sqrtf(float %78) #1
  %80 = tail call float @_Z4sqrtf(float %75) #1
  %81 = tail call float @_Z3cosf(float %77) #1
  %82 = fmul float %79, %81
  %83 = tail call float @_Z3sinf(float %77) #1
  %84 = fmul float %79, %83
  ...
  call void @_ZN18simple_path_tracer13transform_dirER7vector3IfERKS1_S4_S4_(%class.vector3* %dir.i5, %class.vector3* %normal, %class.vector3* %63, %class.vector3* %64) #2
...
; <label>:109                                     ; preds = %62
  %110 = fmul float %80, 0x3FD45F3060000000
  %111 = fmul float %43, %110
  %112 = fdiv float 0.000000e+00, %111, !fpmath !14
  br label %221

; <label>:113                                     ; preds = %28
  %114 = fadd float %43, %54
...
; <label>:116                                     ; preds = %113
  ...
  %120 = fmul float %31, %15
  %121 = fadd float %119, %120
  %122 = fmul float %121, 2.000000e+00
  %123 = fmul float %30, %122
  %124 = fmul float %29, %122
  %125 = fmul float %31, %122
  %126 = fsub float %4, %123
  %127 = fsub float %9, %124
  %128 = fsub float %15, %125
...
_ZNK7vector3IfE7is_nullEv.exit.thread.i:          ; preds = %116
  %132 = fmul float %126, %126
  %133 = fmul float %127, %127
  %134 = fadd float %132, %133
  %135 = fmul float %128, %128
  %136 = fadd float %135, %134
  %137 = tail call float @_Z5rsqrtf(float %136) #1
  %138 = fmul float %126, %137
  %139 = fmul float %127, %137
  %140 = fmul float %128, %137
  br label %_ZNK7vector3IfE10normalizedEv.exit
...
_ZNK7vector3IfE10normalizedEv.exit:               ; preds = %_ZNK7vector3IfE7is_nullEv.exit.thread.i, %116
  ...
  %163 = fmul float %154, 0x401921FB60000000
  %164 = fadd float %161, 1.000000e+00
  %165 = fdiv float 1.000000e+00, %164, !fpmath !14
  %166 = tail call float @_Z3powff(float %159, float %165) #1
  %167 = fmul float %166, %166
  %168 = fsub float 1.000000e+00, %167
  %169 = tail call float @_Z4sqrtf(float %168) #1
  %170 = tail call float @_Z3cosf(float %163) #1
  %171 = fmul float %169, %170
  %172 = tail call float @_Z3sinf(float %163) #1
  ...
  call void @_ZN18simple_path_tracer13transform_dirER7vector3IfERKS1_S4_S4_(%class.vector3* %dir.i, %class.vector3* %rnormal, %class.vector3* %147, %class.vector3* %148) #2
  %177 = load float* %174, align 4, !tbaa !15
  %178 = load float* %175, align 4, !tbaa !18
  %179 = load float* %176, align 4, !tbaa !19
  %180 = call float @_Z3powff(float %166, float %161) #1
  %181 = fmul float %164, %180
  %182 = fmul float %181, 0x3FC45F3060000000
  call void @llvm.lifetime.end(i64 12, i8* %162)
  %183 = fmul float %177, %30
  %184 = fmul float %178, %29
  %185 = fadd float %183, %184
  %186 = fmul float %179, %31
...
; <label>:193                                     ; preds = %_ZNK7vector3IfE10normalizedEv.exit
  ...
  %200 = fmul float %177, %141
  %201 = fmul float %178, %142
  %202 = fadd float %200, %201
  %203 = fmul float %179, %143
  ...
  %207 = call float @_Z3powff(float %..i3, float %206) #1
  %208 = fmul float %195, %207
  %209 = fmul float %197, %207
  %210 = fmul float %199, %207
  %211 = fcmp ogt float %187, 0.000000e+00
  %..i = select i1 %211, float %187, float 0.000000e+00
  %212 = fmul float %..i, %208
  %213 = fmul float %..i, %209
  %214 = fmul float %..i, %210
...
; <label>:218                                     ; preds = %193
  %219 = fmul float %54, %182
  %220 = fdiv float 0.000000e+00, %219, !fpmath !14
  br label %221
