...
static constant constexpr const float3 cornell_vertices[] {
	// floor / 0
...
static constant constexpr const uint3 cornell_indices[size(cornell_vertices) / 2] {
	// floor
	uint3 { 0, 1, 2 },
	uint3 { 0, 2, 3 },
...
static constant constexpr const CORNELL_OBJECT cornell_object_map[size(cornell_indices)] {
...
static constant constexpr const material cornell_materials[(size_t)CORNELL_OBJECT::__OBJECT_COUNT] {
	// floor
	material {
		.diffuse = { 0.407843f },
		.specular = { 0.0f },
