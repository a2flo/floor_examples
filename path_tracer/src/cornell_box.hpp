...
alignas(16) static constant constexpr const float3 cornell_vertices[] {
	// floor / 0
...
alignas(16) static constant constexpr const uint3 cornell_indices[size(cornell_vertices) / 2] {
	// floor
	uint3 { 0, 1, 2 },
	uint3 { 0, 2, 3 },
