...
static constant constexpr const const_array<uint3, cornell_vertices.size() / 2> cornell_indices {{
	// floor
	uint3 { 0, 1, 2 },
	uint3 { 0, 2, 3 },
...
static constant constexpr const const_array<CORNELL_OBJECT, cornell_indices.size()> cornell_object_map {{
