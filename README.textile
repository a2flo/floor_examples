...
* build with "./build.sh" inside the folder
* gather-based warping ref: "Image-Based Bidirectional Scene Reprojection":https://www.cse.ust.hk/~psander/docs/bireproj.pdf ("original":https://web.archive.org/web/20170611112307/http://www.cs.virginia.edu:80/~gfx/pmwiki/index.php?n=Pubs.Yang2011IBB)
